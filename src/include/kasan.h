...
static inline void kasan_heap_init(uintptr_t heap_start, size_t heap_size) {
    (void)heap_start;
    (void)heap_size;
}
static inline void kasan_heap_extend(uintptr_t heap_start, size_t heap_size) {
    (void)heap_start;
    (void)heap_size;
}
static inline void kasan_poison(const void *addr, size_t size) {
    (void)addr;
    (void)size;
}
...
static inline void kasan_check_range(const void *addr, size_t size, bool is_write,
                                     const char *reason) {
    (void)addr;
    (void)size;
    (void)is_write;
...
static inline bool kasan_is_active(void) { return false; }
static inline void kasan_push_disable(void) {}
static inline void kasan_pop_disable(void) {}
static inline void kasan_check_read(const void *addr, size_t size) {
    (void)addr;
    (void)size;
}
