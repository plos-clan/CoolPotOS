 ...
 * 内核编号格式:
 *    内核名称-非架构相关代码版本_(git:<git哈希>)_{编译器名称 编译器版本}
 */

#define KERNEL_NAME_   "CP_Kernel"
#define KERNEL_VERSION "v0.4.0" // 非架构相关更新版本号
...
#define KERNEL_NAME                                                                                \
    (KERNEL_NAME_ "-" KERNEL_ARCH "-" KERNEL_VERSION "_(git:" GIT_VERSION ")_{" COMPILER_NAME       \
                  " " COMPILER_VERSION "}")
