...
uint32_t drm_find_free_slot(void **array, const uint32_t size) {
...
void drm_connector_free(drm_resource_manager_t *mgr, const uint32_t id) {
    spin_lock(mgr->lock);
...
drm_connector_t *drm_connector_get(drm_resource_manager_t *mgr, const uint32_t id) {
    spin_lock(mgr->lock);
...
void drm_crtc_free(drm_resource_manager_t *mgr, const uint32_t id) {
    spin_lock(mgr->lock);
...
drm_crtc_t *drm_crtc_get(drm_resource_manager_t *mgr, const uint32_t id) {
    spin_lock(mgr->lock);
...
void drm_encoder_free(drm_resource_manager_t *mgr, const uint32_t id) {
    spin_lock(mgr->lock);
...
drm_encoder_t *drm_encoder_get(drm_resource_manager_t *mgr, const uint32_t id) {
    spin_lock(mgr->lock);
...
void drm_framebuffer_free(drm_resource_manager_t *mgr, const uint32_t id) {
    spin_lock(mgr->lock);
...
drm_framebuffer_t *drm_framebuffer_get(drm_resource_manager_t *mgr, const uint32_t id) {
    spin_lock(mgr->lock);
...
static bool drm_framebuffer_is_bound_locked(drm_device_t *dev, const uint32_t id) {
    if (!dev) {
        return false;
    }
...
void drm_framebuffer_cleanup_closed(drm_device_t *dev, const uint32_t id) {
    if (!dev || id == 0) {
        return;
    }
...
void drm_plane_free(drm_resource_manager_t *mgr, const uint32_t id) {
    spin_lock(mgr->lock);
...
drm_plane_t *drm_plane_get(drm_resource_manager_t *mgr, const uint32_t id) {
    spin_lock(mgr->lock);
