 ...
 *\return 新的红黑树节点指针
 */
extern rbtree_sp_t rbtree_sp_alloc(const char *key, void *value) __THROW __attr_malloc;

/**
 *\brief 释放红黑树
 *\param[in] root 树的根节点
 */
extern void rbtree_sp_free(rbtree_sp_t root) __THROW;

extern void rbtree_sp_free_with(rbtree_sp_t root, void (*free_value)(void *)) __THROW;
 ...
 */
extern void *rbtree_sp_get(rbtree_sp_t root, const char *key) __THROW;
 ...
 */
extern bool rbtree_sp_search(rbtree_sp_t root, void *value, const char **key) __THROW;
 ...
 *\return 插入节点后的树的根节点
 */
extern rbtree_sp_t rbtree_sp_insert(rbtree_sp_t root, const char *key, void *value) __THROW __wur;
 ...
 *\return 删除节点后的树的根节点
 */
extern rbtree_sp_t rbtree_sp_delete(rbtree_sp_t root, const char *key) __THROW __wur;

/**
 *\brief 按照中序遍历打印红黑树节点
 *\param[in] root 树的根节点
 */
extern void rbtree_sp_print_inorder(rbtree_sp_t root) __THROW;

/**
 *\brief 按照前序遍历打印红黑树节点
 *\param[in] root 树的根节点
 */
extern void rbtree_sp_print_preorder(rbtree_sp_t root) __THROW;
 ...
 *\return 旋转后的树的根节点
 */
static rbtree_sp_t rbtree_sp_left_rotate(rbtree_sp_t root, rbtree_sp_t x) __THROW __wur;
 ...
 *\return 旋转后的树的根节点
 */
static rbtree_sp_t rbtree_sp_right_rotate(rbtree_sp_t root, rbtree_sp_t y) __THROW __wur;
 ...
 *\return 修复后的树的根节点
 */
static rbtree_sp_t rbtree_sp_insert_fixup(rbtree_sp_t root, rbtree_sp_t z) __THROW __wur;
