 ...
 * sizeof(FSE_FUNCTION_TYPE)` workSpace must also be properly aligned with FSE_FUNCTION_TYPE
 * requirements
 */
size_t FSE_buildCTable_wksp(
    ...
    /* Build table */
    {
        ...
        for (u = 0; u < tableSize; u++) {
            FSE_FUNCTION_TYPE s = tableSymbol[u]; /* note : static analyzer may not understand
