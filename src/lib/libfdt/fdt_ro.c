...
int fdt_path_offset_namelen(const void *fdt, const char *path, int namelen) {
    ...
    if (!can_assume(VALID_INPUT) && namelen <= 0) return -FDT_ERR_BADPATH;
...
static const struct fdt_property *fdt_get_property_by_offset_(const void *fdt, int offset,
                                                              int *lenp) {
    int                        err;
...
static const struct fdt_property *fdt_get_property_namelen_(const void *fdt, int offset,
                                                            const char *name, int namelen,
                                                            int *lenp, int *poffset) {
...
static const void *fdt_path_getprop_namelen(const void *fdt, const char *path, const char *propname,
