...
set(ROOTFS_UNCOMPRESSED ${CMAKE_CURRENT_BINARY_DIR}/cp_rootfs-uncompressed.sfs)

add_custom_target(iso ALL
        DEPENDS kernel e1000 fatfs iso9660 squashfs fetch_limine_binaries

        COMMAND ${CMAKE_COMMAND} -E remove_directory ${ISO_DIR}
        COMMAND ${CMAKE_COMMAND} -E make_directory ${ISO_DIR}/limine
        COMMAND ${CMAKE_SOURCE_DIR}/tools/repack_sqsh_uncompressed.sh ${CMAKE_CURRENT_SOURCE_DIR}/assets/cp_rootfs.sfs ${ROOTFS_UNCOMPRESSED}
        ...
        COMMAND ${CMAKE_COMMAND} -E copy_if_different ${CMAKE_CURRENT_SOURCE_DIR}/assets/minirootfs_x86_64.tar.zst ${ISO_DIR}/minirootfs_x86_64.tar.zst
        ...
        COMMAND ${CMAKE_COMMAND} -E copy_if_different ${ROOTFS_UNCOMPRESSED} ${ISO_DIR}/cp_rootfs.sfs
