 ...
 */
extern bool list_search(const list_t *list, const void *data);
 ...
 *\return 更新后的链表头指针
 */
extern list_t *list_delete(list_t *list, const void *data);
 ...
 *\return 链表的长度
 */
extern size_t list_length(const list_t *list);
...
static list_t *list_nth(list_t *list, const size_t n) {
    if (list == NULL) {
        return NULL;
    }
    list = list_head(list);
...
static list_t *list_nth_last(list_t *list, const size_t n) {
    if (list == NULL) {
        return NULL;
    }
    list = list_tail(list);
...
static bool list_search(const list_t *list, const void *data) {
...
static list_t *list_delete(list_t *list, const void *data) {
    if (list == NULL) {
        return NULL;
    }
...
static list_t *list_delete_with(list_t *list, const void *data, const free_t callback) {
    if (list == NULL) {
        return NULL;
    }
...
static list_t *list_delete_node_with(list_t *list, list_t *node, const free_t callback) {
    if (list == NULL || node == NULL) {
        return list;
    }
...
static size_t list_length(const list_t *list) {
    size_t count    = 0;
    const list_t *current = list;
    while (current != NULL) {
        count++;
